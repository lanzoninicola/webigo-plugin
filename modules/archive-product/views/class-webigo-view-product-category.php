...
class Webigo_View_Product_Category
{
    ...
    private function render_category_info() 
    {
        ...
        foreach ( $this->category->custom_fields() as $custom_field => $custom_field_values ) {
            ...
            if( ! empty( $custom_field_values['value'] ) ) {
                ...
                echo '<div class="webigo-category-info-detail-description" data-visualization="hidden">' . esc_html($custom_field_values['description']) . '</div>';
                echo '</div>';
            }
        }
        echo '</div>';
    ...
    private function arrow_expand_collapse() {
        ...
        echo '<div class="arrow-expand arrow-toggle-expand-collapse" data-visualization="hidden" data-category-id="' . esc_html( $this->category->id() ) . '">
    ...
    //     echo '<div class="arrow-collapse arrow-toggle-expand-collapse" data-visualization="hidden" data-category-id="' . esc_html( $this->category->id() ) . '">
    ...
    private function render_products() {
        ...
        echo '<ul class="webigo-product-list" data-visualization="hidden" data-category-id="' . $this->category->id() . '">';
