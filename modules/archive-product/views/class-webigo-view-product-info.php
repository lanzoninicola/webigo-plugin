...
class Webigo_View_Product_Info {
    ...
    public function render() : string
    {
        ...
        $output .= $this->product_price->render();
    ...
    public function render_image() : string
    {
        ...
        $output = '<div class="wbg-product-image">';
    ...
    private function render_description() : string
    {
        ...
        $output .= '<div class="action-buttons info-description" data-product-id="' . esc_attr( $this->product->id() ) . '" data-category-id="' . esc_attr( $this->category->id() ) . '">';
