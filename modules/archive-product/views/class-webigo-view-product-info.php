...
class Webigo_View_Product_Info {
    ...
    private function render_description() {
        ...
        echo '<p class="wbg-product-description" data-visibility="clamped">' . esc_html( $this->product->description() ) . '</p>';
        
        echo '<div class="action-buttons info-description" data-product-id="' . esc_attr( $this->product->id() ) . '" data-category-id="' . esc_attr( $this->category->id() ) . '">';
